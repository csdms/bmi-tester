...
def test_get_var_itemsize():
    ...
    for name in all_names(bmi):
        ...
        _check_var_itemsize.description = "Test get_var_itemsize for {name}".format(
            name=name
        )
...
def test_get_var_nbytes():
    ...
    for name in all_names(bmi):
        ...
        _check_var_nbytes.description = "Test get_val_nbytes for {name}".format(
            name=name
        )
...
def test_get_var_units():
    ...
    for name in all_names(bmi):
        ...
        _check_units_is_str.description = "Test units for {name} is str".format(
            name=name
        )
        _check_units_is_valid.description = "Test units for {name} is valid".format(
            name=name
        )
